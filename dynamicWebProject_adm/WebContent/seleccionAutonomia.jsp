		...
		<div class="container">
			<div class="row">
				...
				<div id="content" class="12u skel-cell-important">
					<section>
						<header class="major">
							<h2>SELECCIONE COMUNIDAD AUTÓNOMA</h2>
						</header>

						<form action="autonomicas.jsp" method="post" class="">

							<div style="z-index: 1;">
								<div class="dropdown">
									<button name="autonomia" onclick="myFunctiondd()"
										class="dropbtn" type="button">Comunidad Autónoma</button>
									<div id="myDropdown" class="dropdown-content">
										...
										<a href="#"
											data-value="<%=campannasAutonomicas.get(i).getCod_campanna()%>"
											onclick="seleccionarEvento(this)"><img
											src="images/banderas/<%=campannasAutonomicas.get(i).getCod_campanna()%>.png"
											style="width: 20%"> <%=campannasAutonomicas.get(i).getAmbito()%><input
											type="hidden" name="campanna"
											value="<%=campannasAutonomicas.get(i).getCod_campanna()%>" /></a>
