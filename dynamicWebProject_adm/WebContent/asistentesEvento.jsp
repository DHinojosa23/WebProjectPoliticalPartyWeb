...
<%
	...
	<div id="main" class="wrapper style4">
		<div id="formA">
			...
			<form action="asistentesEventoElegido.jsp" method="post">
				<div style="z-index: 1;">
					<div class="dropdown">
						...
						<a href="#"
							...
							<%
										...
										<a href="#"
											data-value="<%=eventos.get(i).getCod_evento()%>"
											onclick="seleccionarEvento(this)"><img
				...
				<br> <input type="submit" name="enviar" value="Seleccionar">
